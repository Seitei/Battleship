package ships
{
    ...
    public class Ship extends Sprite
	{
		...
		public function Ship(shipName:String, cost:int, size:int, attackPower:int, visual:Image, visualRoster:Image, highlight:Image, state:String, assetManager:AssetManager)
		{
		...
		private function createUI(size:int):void {
            ...
            for(var k:int = 0; k < _attackPower; k ++){

                var redQuad:Quad = new Quad(18, 4, 0xEF414E);
                redQuad.x = k * TILE_SIZE + 2;
		...
		private function createState(state:String):void {
            ...
            switch(state) {
				...
				case "placed":
                    ...
                    //delete button
                    var upState:Image = new Image(_assetManager.getTexture("delete_ship_button_up"));
                    upState.name = "up0000";
                    var hoverState:Image = new Image(_assetManager.getTexture("delete_ship_button_hover"));
                    hoverState.name = "hover0000";
                    var downState:Image = new Image(_assetManager.getTexture("delete_ship_button_hover"));
        ...
        private function onShipDeleted(e:Event):void {
