...
import ships.Ship;
    ...
    public class Game extends Sprite implements iGame
	{
        ...
        public static const GAME_NAME:String = "Battleship";
        ...
        private var _turns:Turns;
        private var _gameID:String;
        private var _matchID:int;

		public function Game(player:Player, assetManager:AssetManager, matchID:int, gameID:String)
		{
            ...
            _player = player;
         	_assetManager = assetManager as AssetManager;
        ...
        public function onEnemyTurnEnd(message:Object):void {

            _turns.onEnemyTurnEnd(message);
        ...
        private function onSendData(e:Event, data:Object):void {
            ...
            dispatchEventWith("sendData", false, {data: data, game: this});
	   ...
	   private function processEnemyFleetCondensed(fleet:Array):void {
        ...
        private function checkIfCanPlaceShip(shipToPlace:Ship, rectangle:Rectangle = null, touchedShip:Ship = null):Boolean {
            ...
            var gridRec:Rectangle = _myGrid.getBounds(this);
        ...
        public function get turns():Turns {
            return _turns;
        }
